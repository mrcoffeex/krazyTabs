                                                ...
                                                <tr>
                                                    ...
                                                    <?php  
                                                        ...
                                                        while ($category=$getCategories->fetch(PDO::FETCH_ASSOC)) {
                                                            ...
                                                            $realAverage = calculateIfZero($allTotal, $countActiveJudges, "division", 2);

                                                            $finalCategoryPercentage = getAverageValueByCategoryPercentage($realAverage, getCategoryPercentage($category['tabs_cat_id']));

                                                            $totalScore += $finalCategoryPercentage;
                                                    ?>
                                                    <td class="p-2 text-center"><?= RealNumber($finalCategoryPercentage, 2); ?></td>
                                                    <?php } ?>
