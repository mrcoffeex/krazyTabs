                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="password" class="form-control" name="password" value="<?= decryptIt($judge['tabs_password']) ?>" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Event</label>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="submit" id="submit_update_judge" class="btn btn-info">Update</button>
